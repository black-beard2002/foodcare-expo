...
interface AuthState {
  ...
  // API Actions
  signInWithPhone: (phoneNumber: string) => Promise<{ success: boolean; verificationId?: string; error?: string }>;
      ...
      signInWithPhone: async (phoneNumber: string) => {
        ...
        try {
          ...
          if (response.success && response.data) {
            return { success: true, verificationId: response.data.verificationId };
          } else {
